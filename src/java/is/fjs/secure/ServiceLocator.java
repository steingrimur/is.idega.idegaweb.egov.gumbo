...
public class ServiceLocator extends org.apache.axis.client.Service implements is.fjs.secure.Service {
    ...
    private java.lang.String ServiceSoap_address = "http://securep.fjs.is/webfjs/ws-fks/service.asmx";
    ...
    public is.fjs.secure.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            is.fjs.secure.ServiceSoapStub _stub = new is.fjs.secure.ServiceSoapStub(portAddress, this);
    ...
    private java.lang.String ServiceSoap12_address = "http://securep.fjs.is/webfjs/ws-fks/service.asmx";
    ...
    public is.fjs.secure.ServiceSoap getServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            is.fjs.secure.ServiceSoap12Stub _stub = new is.fjs.secure.ServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (is.fjs.secure.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                is.fjs.secure.ServiceSoapStub _stub = new is.fjs.secure.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
            if (is.fjs.secure.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                is.fjs.secure.ServiceSoap12Stub _stub = new is.fjs.secure.ServiceSoap12Stub(new java.net.URL(ServiceSoap12_address), this);
                _stub.setPortName(getServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://secure.fjs.is/", "Service");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://secure.fjs.is/", "ServiceSoap"));
            ports.add(new javax.xml.namespace.QName("http://secure.fjs.is/", "ServiceSoap12"));
        }
