/**
 * GethlutdeildutgerdtegResponseElement.java
 *
...
public class GethlutdeildutgerdtegResponseElement  implements java.io.Serializable {
    private is.fiskistofa.webservices.hlutdeild.FSWebserviceHLUTDEILD_wsdl.types.HlutdeildTypeUser result;

    public GethlutdeildutgerdtegResponseElement() {
    }
    ...
    /**
     * Gets the result value for this GethlutdeildutgerdtegResponseElement.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this GethlutdeildutgerdtegResponseElement.
     * 
     * @param result
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GethlutdeildutgerdtegResponseElement)) return false;
        GethlutdeildutgerdtegResponseElement other = (GethlutdeildutgerdtegResponseElement) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GethlutdeildutgerdtegResponseElement.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://is/fiskistofa/webservices/hlutdeild/FSWebserviceHLUTDEILD.wsdl/types/", ">gethlutdeildutgerdtegResponseElement"));
