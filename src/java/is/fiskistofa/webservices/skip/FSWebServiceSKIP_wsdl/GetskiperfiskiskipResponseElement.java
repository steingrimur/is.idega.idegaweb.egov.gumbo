/**
 * GetskiperfiskiskipResponseElement.java
 *
...
public class GetskiperfiskiskipResponseElement  implements java.io.Serializable {
    private is.fiskistofa.webservices.skip.FSWebServiceSKIP_wsdl.CheckReplyTypeUser result;

    public GetskiperfiskiskipResponseElement() {
    }
    ...
    /**
     * Gets the result value for this GetskiperfiskiskipResponseElement.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this GetskiperfiskiskipResponseElement.
     * 
     * @param result
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetskiperfiskiskipResponseElement)) return false;
        GetskiperfiskiskipResponseElement other = (GetskiperfiskiskipResponseElement) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetskiperfiskiskipResponseElement.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://is/fiskistofa/webservices/skip/FSWebServiceSKIP.wsdl", ">getskiperfiskiskipResponseElement"));
