/**
 * GetskipinfobyeigandiElement.java
 *
...
public class GetskipinfobyeigandiElement  implements java.io.Serializable {
    private java.lang.String pKennitalaEiganda;

    public GetskipinfobyeigandiElement() {
    }
    ...
    /**
     * Gets the pKennitalaEiganda value for this GetskipinfobyeigandiElement.
     * 
    ...
    /**
     * Sets the pKennitalaEiganda value for this GetskipinfobyeigandiElement.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetskipinfobyeigandiElement)) return false;
        GetskipinfobyeigandiElement other = (GetskipinfobyeigandiElement) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetskipinfobyeigandiElement.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://is/fiskistofa/webservices/skip/FSWebServiceSKIP.wsdl", ">getskipinfobyeigandiElement"));
