/**
 * GethefurstrandveidileyfiResponseElement.java
 *
...
public class GethefurstrandveidileyfiResponseElement  implements java.io.Serializable {
    private is.fiskistofa.webservices.veidileyfi.FSWebServiceVeidileyfi_wsdl.types.CheckReplyTypeUser result;

    public GethefurstrandveidileyfiResponseElement() {
    }
    ...
    /**
     * Gets the result value for this GethefurstrandveidileyfiResponseElement.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this GethefurstrandveidileyfiResponseElement.
     * 
     * @param result
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GethefurstrandveidileyfiResponseElement)) return false;
        GethefurstrandveidileyfiResponseElement other = (GethefurstrandveidileyfiResponseElement) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GethefurstrandveidileyfiResponseElement.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://is/fiskistofa/webservices/veidileyfi/FSWebServiceVEIDILEYFI.wsdl/types/", ">gethefurstrandveidileyfiResponseElement"));
