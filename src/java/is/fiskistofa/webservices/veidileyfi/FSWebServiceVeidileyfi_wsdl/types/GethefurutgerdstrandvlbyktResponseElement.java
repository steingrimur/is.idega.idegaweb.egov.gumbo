/**
 * GethefurutgerdstrandvlbyktResponseElement.java
 *
...
public class GethefurutgerdstrandvlbyktResponseElement  implements java.io.Serializable {
    private is.fiskistofa.webservices.veidileyfi.FSWebServiceVeidileyfi_wsdl.types.CheckReplyTypeUser result;

    public GethefurutgerdstrandvlbyktResponseElement() {
    }
    ...
    /**
     * Gets the result value for this GethefurutgerdstrandvlbyktResponseElement.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this GethefurutgerdstrandvlbyktResponseElement.
     * 
     * @param result
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GethefurutgerdstrandvlbyktResponseElement)) return false;
        GethefurutgerdstrandvlbyktResponseElement other = (GethefurutgerdstrandvlbyktResponseElement) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GethefurutgerdstrandvlbyktResponseElement.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://is/fiskistofa/webservices/veidileyfi/FSWebServiceVEIDILEYFI.wsdl/types/", ">gethefurutgerdstrandvlbyktResponseElement"));
