/**
 * VirkjaveidileyfiResponseElement.java
 *
...
public class VirkjaveidileyfiResponseElement  implements java.io.Serializable {
    private is.fiskistofa.webservices.veidileyfi.FSWebServiceVeidileyfiUpdate_wsdl.types.CodeTypeUser result;

    public VirkjaveidileyfiResponseElement() {
    }
    ...
    /**
     * Gets the result value for this VirkjaveidileyfiResponseElement.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this VirkjaveidileyfiResponseElement.
     * 
     * @param result
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VirkjaveidileyfiResponseElement)) return false;
        VirkjaveidileyfiResponseElement other = (VirkjaveidileyfiResponseElement) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VirkjaveidileyfiResponseElement.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://is/fiskistofa/webservices/veidileyfi/FSWebServiceVeidileyfiUpdate.wsdl/types/", ">virkjaveidileyfiResponseElement"));
