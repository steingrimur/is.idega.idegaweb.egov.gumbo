/**
 * GetersviptingResponseElement.java
 *
...
public class GetersviptingResponseElement  implements java.io.Serializable {
    private is.fiskistofa.webservices.veidileyfi.FSWebServiceVEIDILEYFI_wsdl.types.CheckReplyTypeUser result;

    public GetersviptingResponseElement() {
    }
    ...
    /**
     * Gets the result value for this GetersviptingResponseElement.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this GetersviptingResponseElement.
     * 
     * @param result
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetersviptingResponseElement)) return false;
        GetersviptingResponseElement other = (GetersviptingResponseElement) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetersviptingResponseElement.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://is/fiskistofa/webservices/veidileyfi/FSWebServiceVEIDILEYFI.wsdl/types/", ">getersviptingResponseElement"));
