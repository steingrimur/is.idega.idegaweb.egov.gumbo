...
@Service("aquaCultureReportToFocalHandler")
@Scope("prototype")
public class AquaCultureReportToFocalHandler extends
		SetProcessDescriptionHandler implements ActionHandler {
	...
	private static final Logger LOGGER = Logger
			.getLogger(AquaCultureReportToFocalHandler.class.getName());
	...
	public void execute(ExecutionContext context) throws Exception {
		...
		ProcessFocalCode focalCode = getGumboDAO().getProcessFocalCode(
