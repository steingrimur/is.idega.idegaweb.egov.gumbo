...
public class CatchQuotaEntryViewer extends IWBaseComponent {
	...
	public void initializeComponent(FacesContext context) {
		...
		bean.setTransferInfo(getClient().getTransferInfo(new BigDecimal(reference)));
	
		FaceletComponent facelet = (FaceletComponent) iwc.getApplication().createComponent(FaceletComponent.COMPONENT_TYPE);
		facelet.setFaceletURI(iwb.getFaceletURI("catchQuota/quotaEntryViewer.xhtml"));
		add(facelet);
	}	
